...
namespace EmployeeHR.Data
{
    public class HRDBContext : IdentityDbContext
    {
        ...
        public DbSet<EmployeeHR.ViewModels.UserViewModel> UserViewModel { get; set; } = default!;
        public DbSet<EmployeeHR.ViewModels.UserRolesViewModel> UserRolesViewModel { get; set; } = default!;
    }
}
